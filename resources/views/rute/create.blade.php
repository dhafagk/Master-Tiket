    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Create Rute</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create Rute
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form action="/rute" method="post" class="form">
                    	{{csrf_field()}}
                      <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('depart_at') ? ' has-error' : '' }}">
                          ...
                          data-placement="top" data-title="Depart At">
                        ...
                        <div class="form-group{{ $errors->has('rute_from') ? ' has-error' : '' }}">
                          <label for="issueinput1">Rute From</label>

                          <input type="text" id="issueinput1" class="form-control" placeholder="Rute From"
                          name="rute_from" data-toggle="tooltip" data-trigger="hover"
                          data-placement="top" data-title="Rute From">
                        ...
                        <div class="form-group{{ $errors->has('rute_to') ? ' has-error' : '' }}">
                          <label for="issueinput1">Rute To</label>

                          <input type="text" id="issueinput1" class="form-control" placeholder="Rute To"
                          name="rute_to" data-toggle="tooltip" data-trigger="hover"
                          data-placement="top" data-title="Rute To">
                      ...
                      <div class="input-group">
                        ...
                        <div class="form-group">
                          ...
                          data-trigger="hover" data-placement="top" data-title="Transportation">
