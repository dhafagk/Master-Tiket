      ...
      <div class="content-header-right col-md-6 col-12">
          ...
          <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
           ...
           type="button" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="true"><a href="#" style="color:white;text-decoration: none"> Kelas</a></button>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="/rute/{{$as->id}}">Detail</a>

                              <a class="dropdown-item" href="/rute/{{$as->id}}/edit">Edit</a>
                              <a class="dropdown-item" href="{{url('rute/delete',$as->id)}}">Delete</a>
                            </div>
                          </div></td>
                        </tr>
                        @endforeach
