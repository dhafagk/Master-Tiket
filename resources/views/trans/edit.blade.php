    ...
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">Edit Transportation</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Edit Transportation
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form action="/trans/{{$transport->id}}" method="post" class="form">
                      {{csrf_field()}}
                      ...
                      <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                          ...
                          name="code" value="{{$transport->code}}" data-toggle="tooltip" data-trigger="hover"
                          data-placement="top" data-title="Code" >
                  ...
                  @endif
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                          ...
                          <input type="text" id="issueinput1" class="form-control" placeholder="nama lengkap"
                          name="description" value="{{$transport->description}}" data-toggle="tooltip" data-trigger="hover"
                          data-placement="top" data-title="Description" >
                  ...
                  @endif
                        ...
                        <div class="form-group{{ $errors->has('seat_qty') ? ' has-error' : '' }}">
                          ...
                          <input type="text" id="issueinput1" class="form-control" placeholder="nama lengkap"
                          name="seat_qty" value="{{$transport->seat_qty}}" data-toggle="tooltip" data-trigger="hover"
                          data-placement="top" data-title="Seat QTY" >
                  ...
                  @endif
                        ...
                        <div class="form-group">
                          ...
                          data-trigger="hover" data-placement="top" data-title="Transportation Type">
                            ...
                            @foreach($types as $u)
                            <option value="{{$u->id}}"@if(($u->id) == ($transport->transportation_typeid)) selected @endif>{{$u->description}}</option>
                            @endforeach
                          </select>
                        </div>
